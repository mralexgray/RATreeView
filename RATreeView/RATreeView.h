...
@required
+ dataObjectWithName:(NSString*)name children:(NSArray*)children;
 ...
 */
- (id)treeView:(RATreeView*)_ child:(NSInteger)index ofItem:(id<RADataObject>)item;
...
- (void)expandRowForItem:_ withRowAnimation:(RATreeViewRowAnimation)animation;
- (void)collapseRowForItem:_ withRowAnimation:(RATreeViewRowAnimation)animation;
